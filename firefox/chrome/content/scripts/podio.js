...
function PodioTimer() {
    ...
    this.insertButtonIntoPage = function () {
        ...
        a.append($('<span/>', { 'class': 'text', 'style':'line-height: 11px; font-size: 12px; margin-top: 9px; float: right; margin-left: 5px; color: #999' }).text(Locale.get(Locale.messages.synchronizing)));
